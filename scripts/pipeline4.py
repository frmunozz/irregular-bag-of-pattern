...
if __name__ == '__main__':
    ...
    q_arr = [
        ...
        # [["mean"], ["std"], ["trend"], ["mean", "std"], ["mean", "trend"], ["std", "trend"], ["mean", "std", "trend"]],
        # [["mean"], ["std"], ["min_max"], ["mean", "std"], ["mean", "min_max"], ["std", "min_max"], ["mean", "std", "min_max"]],
        # [["mean"], ["trend"], ["min_max"], ["mean", "trend"], ["mean", "min_max"], ["trend", "min_max"], ["mean", "std", "min_max"]],  ## winner
        # [["std"], ["trend"], ["min_max"], ["std", "trend"], ["std", "min_max"], ["trend", "min_max"], ["std", "trend", "min_max"]],

        [["mean", "trend", "min_max"]],  ## winner
        [["mean"], ["trend"], ["min_max"], ["mean", "trend"], ["mean", "min_max"], ["trend", "min_max"]],  ## winner
        [["mean"], ["trend"], ["min_max"], ["mean", "trend"], ["mean", "min_max"], ["trend", "min_max"], ["mean", "trend", "min_max"]],  ## winner
