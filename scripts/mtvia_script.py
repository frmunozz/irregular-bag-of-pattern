...
if __name__ ==  '__main__':
	...
	if True:
		...
		ini1 = time.time()
		train_mtva, train_sizes = dataset_mtvia_repr(train_dataset, train_times, windows, threshold=threshold)
		test_mtva, test_sizes = dataset_mtvia_repr(test_dataset, test_times, windows, threshold=threshold)
		end1 = time.time()
		...
		ini2 = time.time()
		result_pairs = mtvia_distance_mp(train_mtva, test_mtva, len(windows), n_process=n_process)
		end2 = time.time()
